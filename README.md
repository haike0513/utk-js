...
you need to install the @utk/sdk-api  @utk/sdk-core @utk/sdk-router package, understand the structures, and start using it. 
...
```bash
yarn add @utk/sdk-api  @utk/sdk-core @utk/sdk-router
...
import { ModuleBApi } from '@utk/sdk-api';
import { Percent, Token, TokenAmount } from '@utk/sdk-core';
import { firstValueFrom } from 'rxjs';
import { SmartRouterV2 } from '@utk/sdk-router';
...
import { EvmApi } from '@utk/sdk-api';
import { Percent, Token, TokenAmount, TradeType, StablePair, StableSwap } from '@utk/sdk-core';
import { firstValueFrom } from 'rxjs';
import { SmartRouterV2 } from '@utk/sdk-router';
