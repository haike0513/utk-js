...
import { AssetType, Token, TokenAmount, computePairAddress, StandardPair as RegularPair, Pool } from '@utk/sdk-core';
...
export class EvmStandardPool implements StandardPoolModule {
  ...
  public async reserveOfPair (
    ...
    return new Pool(totalLiquidityAmount, token0Amount, token1Amount);
  }
